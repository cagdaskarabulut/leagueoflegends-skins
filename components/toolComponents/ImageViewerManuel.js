...
const ImageViewerManuel = ({ imageName, imagePath, onClickAction, isSmallSize, isSelected }) => {
  return (
    <>
        {/* <img src={imagePath} alt={imageName} key={"img_" + imageName} width={240} onClick={onClickAction}/> */}
        <div className={isSmallSize ? (isSelected ? styles.smallSizeSelected : styles.smallSize) : (isSelected ? styles.standartSizeSelected : styles.standartSize)}>
          <Image
