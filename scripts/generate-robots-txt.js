...
//       console.log(skin);
//       dynamicRobotsTxtFields = `${dynamicRobotsTxtFields}Allow: /${replaceStringForUrlFormat(champion.name)}/${replaceStringForUrlFormat(skin)}
// `;

//       dynamicSitemapFields = `${dynamicSitemapFields}
// <url>
// <loc>
// ${rootPath}/${replaceStringForUrlFormat(champion.name)}/${replaceStringForUrlFormat(skin)}
// </loc>
// <lastmod>
// ${now}
// </lastmod>
